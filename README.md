...
- __Desenvolvedores:__ Realizam atividades de codificação e resolução de problemas técnicos.
- __Gerentes:__ Organizam a equipe e conduzem reuniões.
- __Treinadores:__ Ensinam novas tecnologias e motivam a equipe.
- __Gerente Desenvolvedor:__ Possui responsabilidades de desenvolvedor e gerente.
...
1. __Model (Modelo):__ Representa as entidades e classes abstratas do sistema, como Funcionario,
   Desenvolvedor, Gerente, Treinador e GerenteDesenvolvedor.
2. __View (Visão):__ Responsável pela interface com o usuário. A View deve capturar dados e exibir
   informações sobre os funcionários.
3. __Controller (Controlador):__ Controla o fluxo de dados entre o Model e a View, incluindo a lógica
   de adicionar, listar, atualizar e remover funcionários.

## Requisitos do Projeto
1. Cadastro de Funcionários:
   - Permitir o cadastro de desenvolvedores, gerentes, treinadores e gerente
   desenvolvedores.
   - Cada tipo de funcionário possui atributos e métodos específicos baseados nas
   interfaces e na classe abstrata Funcionario.

2. Armazenamento com ArrayList e Persistência em Arquivo:
   - Utilizar ArrayList para armazenar temporariamente a lista de funcionários durante a
   execução.

   - Persistir os dados em um arquivo de texto para que o sistema possa recuperar os
funcionários cadastrados ao reiniciar.

3. Interfaces e Herança:
   - Utilizar interfaces para definir as responsabilidades de cada tipo de funcionário
   (Desenvolve, Gerencia, Treina).
   - Utilizar herança com uma classe abstrata Funcionario que define os atributos e
   métodos comuns a todos os funcionários.

4. Padrão MVC:
   - Organizar o projeto em pacotes de acordo com o padrão MVC.
   - Model: Contém as classes Funcionario, Desenvolvedor, Gerente, Treinador e
      GerenteDesenvolvedor.
   - Controller: Contém a lógica de negócio para manipulação dos dados dos funcionários.
   - View: Interage com o usuário para inserção e exibição dos dados.
5. Princípios de Clean Code:
   - Aplicar nomes claros e significativos para classes, métodos e variáveis.
   - Dividir o código em métodos e classes de acordo com a responsabilidade única.
   - Evitar métodos longos, criando funções auxiliares sempre que necessário.
   - Manter o código limpo e organizado, com tratamento de exceções e validação de
      entradas.
...
1. Cadastrar Funcionário:
   - O sistema deve permitir que o usuário insira informações específicas para cada tipo de
   funcionário.
2. Listar Funcionários:
   - O sistema deve exibir uma lista de todos os funcionários com seus detalhes
   específicos.

3. Atualizar Dados do Funcionário:
   - Permitir atualizar o nome e o salário de um funcionário existente.
4. Excluir Funcionário:
   - Remover um funcionário da lista, tanto do ArrayList quanto do arquivo de persistência.
5. Recuperar Dados de Funcionários de Arquivo:
   - Ao iniciar o sistema, carregar os dados do arquivo e armazená-los no ArrayList para
   permitir manipulação em tempo de execução.

Instruções para Implementação
1. Crie Pacotes:
   - model: Contém classes que representam dados e lógica do domínio (Funcionario,
      Desenvolvedor, Gerente, etc.).
   - view: Contém classes que lidam com a interface do usuário (FuncionarioView, por
      exemplo).
   - controller: Contém classes que gerenciam a comunicação entre o Model e a View
      (FuncionarioController).

2. Organize o Código:
   - Mantenha métodos curtos e claros, cada um com uma única responsabilidade.
   - Use exceções para tratar erros, como problemas de entrada do usuário ou falhas na
      leitura/escrita de arquivos.

3. Uso de Interfaces e Abstração:
   - Implemente interfaces para definir as responsabilidades (ex.: Desenvolve para
      desenvolvedores, Gerencia para gerentes).
   - Utilize uma classe abstrata para definir os atributos e métodos comuns a todos os
      funcionários.
4. Persistência de Dados:
   - Ao adicionar, atualizar ou excluir um funcionário, atualize o arquivo de texto para
...
1. Dados Comuns a Todos os Funcionários:
   - ID ou identificador único (para identificar e referenciar funcionários no sistema).
   - Nome do funcionário.
   - Salário.

2. Dados Específicos por Tipo de Funcionário:
   - O tipo do funcionário (ex.: Desenvolvedor, Gerente, Treinador GerenteDesenvolvedor)
...
delimitador, como ponto e vírgula (;). Um exemplo de estrutura de linha pode ser: [ID];[Tipo];[Nome];[Salário]

__Exemplo de Conteúdo do Arquivo__
